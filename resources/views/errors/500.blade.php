...
@section('content')
    <div class="flex items-center justify-center min-h-screen bg-gray-800">
        <div class="text-center">
            <h2 class="text-5xl font-bold text-white mb-4">500<span class="text-lg"> Internal Server Error</span></h2>
            <h5 class="text-lg text-white mb-6">Oops! Some error has occurred, the requested page could not be found!</h5>
            <div class="mt-6">
