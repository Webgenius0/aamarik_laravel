                ...
                <div class="container-xxl">
                    <div class="card">
                        <div class="card-header position-relative">
                            <h6 class="fs-17 fw-semi-bold mb-0">Dynamic Page Setting</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-3 col-xxl-3">
                                    <div>
                                        <div class="list-group nav flex-column nav-pills pe-3" id="v-pills-tab"
                                             role="tablist" aria-orientation="vertical">

                                                <a href="{{ route('dynamic_page.create') }}"
                                                   class="list-group-item list-group-item-action {{ request()->is('admin/dynamic-page/create') ? 'active' : '' }}"
                                            ...
                                            @foreach ($dynamicPages as $dynamicPage)
                                                    <a href="{{ route('dynamic_page.edit', $dynamicPage->id) }}"
                                                       class="list-group-item list-group-item-action {{ request()->is('admin/dynamic-page/update/' . $dynamicPage->id) ? 'active' : '' }}">
                                ...
                                <div class="col-xl-9 col-xxl-9">
                                    <div class="tab-content">
                                        <!-- Start:Dynamic Page-Tab -->
                                        <div class="tab-pane fade {{ request()->is('admin/dynamic-page/create') ? 'show active' : '' }}">
                                            <div class="card">
                                                <div
                                                    class="card-header d-flex justify-content-between align-content-center">
                                                    <div class="d-flex align-content-center">
                                                        <strong>Create Dynamic Page</strong>
                                                    </div>
                                                </div>
                                                <div class="card-body">
                                                    <form action="{{ route('dynamic_page.store') }}" class="password_form"
                                                          method="POST">
                                                        <div class="form-group mb-3 px-1">
                                                            <label for="title" class="form-label"><b>Page
                                                                    Title</b></label>
                                                            <input name="page_title" class="form-control" id="page_title"
                                                                   rows="10" placeholder="Enter Page Title"></input>
                                                            @error('title')
                                                        ...
                                                        <div class="form-group mb-3 px-1">
                                                            <label for="page_content" class="form-label"><b>Page
                                                                    Content</b></label>
                                                            <textarea name="page_content" class="form-control" id="page_content" rows="3" placeholder="Enter Page Content"></textarea>
                                                            @error('page_content')
                                                            <span class="text-danger" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                        ...
                                                        <button type="submit"
                                                                class="btn btn-primary px-4 fw-medium d-inline-flex align-items-center justify-content-center gap-1">
                                                            Update
                                                        </button>
                                                    </form>
                                                </div>
                                        ...
                                        {{-- Dynamic Existing Pages --}}
                                        <!-- Start:Selected Dynamic Page Update Tab -->
                                        @foreach ($dynamicPages as $dynamicPage)
                                            <div class="tab-pane {{ request()->is('admin/dynamic-page/update/' . $dynamicPage->id) ? 'show active' : '' }}">
                                                <div class="card">
                                                    <div
                                                        class="card-header d-flex justify-content-between align-content-center">
                                                        <div class="d-flex align-content-center">
                                        ...
                                        @endforeach
                                        <!-- End:Selected Dynamic Page Update Tab -->
...
@push('script')
    {{-- Tailwind --}}
    <script src="https://unpkg.com/tailwindcss-javascript@0.0.5/dist/tailwindcss-javascript.umd.js"></script>
    {{-- Ck Editor --}}
    ...
    <script>
        ...
        $(function() {
            const tinymceOptions = {
                selector: '#page_content, .rich_text_content',
                menubar: false,
                statusbar: false,
                toolbar_sticky: true,
