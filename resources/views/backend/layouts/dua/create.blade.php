...
@section('title', 'Create Dua | ' . $setting->title ?? 'SIS')
                                    ...
                                    <form action="{{ route('dua.store') }}" method="POST">
                                        ...
                                        <div class="flex">
                                            <div class="basis-6/12 pe-3 mb-3">
                                                ...
                                                <textarea name="arabic" id="arabic" cols="30" rows="10" placeholder="Enter Arabic"
                                                    class="form-input w-full border border-gray-300 rounded p-2 bg-gray-100">{{ old('arabic') }}</textarea>
                                                @error('arabic')
                                                    <span class="text-red-500 text-sm" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="basis-6/12 pe-3 mb-3">
                                                <label class="block text-sm font-medium mb-2" for="en_translate">English
                                                    Translate</label>
                                                <textarea name="en_translate" id="en_translate" cols="30" rows="10" placeholder="Enter English Translate"
                                                    class="form-input w-full border border-gray-300 rounded p-2 bg-gray-100">{{ old('en_translate') }}</textarea>
                                                @error('en_translate')
                                                    <span class="text-red-500 text-sm" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="">
                                            <div class="basis-6/12 pe-3 mb-3">
                                                ...
                                                <textarea name="meaning" id="meaning" cols="30" rows="10" placeholder="Enter meaning"
                                                    class="form-input w-full border border-gray-300 rounded p-2 bg-gray-100">{{ old('meaning') }}</textarea>
                                                @error('meaning')
                                                    <span class="text-red-500 text-sm" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="mt-5 flex">
                                            ...
                                            <div class="pe-3 mb-3 basis-6/12">
                                                <label class="block text-sm font-medium mb-2" for="book_name">Book
                                                    Name</label>
                                                <input type="text" name="book_name" id="book_name"
                                                    placeholder="Enter Book Name" value="{{ old('book_name') }}"
                                                    class="form-input w-full border border-gray-300 rounded p-2 bg-gray-100">
                                                @error('book_name')
                                                    <span class="text-red-500 text-sm" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="mt-5 flex">
                                            ...
                                            <div class="pe-3 mb-3 basis-4/12">
                                                ...
                                                <input type="number" name="book_no" id="book_no"
                                                    placeholder="Enter Book No" value="{{ old('book_no') }}"
                                                    class="form-input w-full border border-gray-300 rounded p-2 bg-gray-100">
                                                @error('book_no')
                                                    <span class="text-red-500 text-sm" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="pe-3 mb-3 basis-4/12">
                                                <label class="block text-sm font-medium mb-2" for="volume">Hadith
                                                    No</label>
                                                <input type="text" name="hadith_no" id="hadith_no"
                                                    placeholder="Enter Book Name" value="{{ old('hadith_no') }}"
                                                    class="form-input w-full border border-gray-300 rounded p-2 bg-gray-100">
                                                @error('hadith_no')
                                                    <span class="text-red-500 text-sm" role="alert">
                                                        <strong>{{ $message }}</strong>
    ...
    <script>
        $(document).ready(function() {
            $('#category_id').on('change', function() {
                ...
                if (categoryId) {
                    $.ajax({
                        url: '{{ url('admin/categories') }}/' + categoryId + '/subcategories',
                        ...
                        error: function() {
                            alert('Failed to retrieve subcategories.');
                        }
                    });
                } else {
                    $('#subcategory_id').empty();
