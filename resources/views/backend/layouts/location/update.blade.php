...
@section('title', 'Edit Location | ' . $setting->title ?? 'Cazzle')
                        ...
                        <div class="overflow-hidden">
                            <div class="mb-4 bg-white rounded-xl shadow-lg">
                                <div class="relative px-4 py-3 border-b flex justify-between align-middle">
                                    <h6 class="text-lg font-semibold mb-0">Edit Location</h6>
                                    <a href="{{ route('location.index') }}"
                                        class="btn bg-info text-white py-2 px-5 hover:bg-success rounded-md">View All</a>
                                </div>
                                <div class="p-4">
                                    <form action="{{ route('location.update', ['id' => $location->id]) }}" enctype="multipart/form-data" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" name="update_id" value="{{ $location->id }}">
                                        <div class="flex">
                                            <div class="basis-5/12 pe-3 ">
                                                <div class="pe-3 mb-3">
                                                    ...
                                                    <input type="text" name="title" id="title"
                                                        placeholder="Enter Location Title" value="{{ old('title', $location->title) }}"
                                            ...
                                            <div class="basis-5/12 pe-3">
                                                <div class="pe-3 mb-3">
                                                    ...
                                                    <input type="text" name="address" id="address"
                                                        placeholder="Enter Location Address" value="{{ old('address', $location->address) }}"
                                                        class="form-input w-full border border-gray-300 rounded p-2 bg-gray-100">
                                                    @error('address')
                                                        <span class="text-red-500 text-sm" role="alert">
                                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="basis-2/12 pe-3">
                                                <div class="pe-3 mb-3">
                                                    ...
                                                    <input type="number" name="points" id="points"
                                                        placeholder="Enter Points" value="{{ old('points', $location->points) }}"
                                                        class="form-input w-full border border-gray-300 rounded p-2 bg-gray-100">
                                                    @error('points')
                                                        <span class="text-red-500 text-sm" role="alert">
                                                            <strong>{{ $message }}</strong>
                                        ...
                                        <div class="my-2">
                                            ...
                                            <div class=" pe-3 mb-3">
                                                <label class="block text-sm font-medium mb-2" for="subtitle">
                                                    Subtitle</label>
                                                    <textarea name="subtitle" id="subtitle" placeholder="Enter Subtitle" class="form-input w-full border border-gray-300 rounded p-2 bg-gray-100" cols="30" rows="5">{{ old('subtitle', $location->subtitle) }}</textarea>
                                                @error('subtitle')
                                                    <span class="text-red-500 text-sm" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="flex my-2">
                                            <div class="basis-6/12 pe-3 ">
                                                <div class="pe-3 mb-3">
                                                    ...
                                                    <input type="file" name="image" data-default-file="{{asset($location->image??'backend/assets/images/image-placeholder.png')}}" id="image" class="dropify form-input w-full border border-gray-300 rounded p-2 bg-gray-100">
                                                    @error('image')
                                                        <span class="text-red-500 text-sm" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="basis-6/12 pe-3 ">
                                                <div class="pe-3 mb-3">
                                                    ...
                                                    <input type="file" name="puzzle_image" id="puzzle_image"  data-default-file="{{asset($location->puzzle_image??'backend/assets/images/puzzle-image-placeholder.png')}}" class="dropify form-input w-full border border-gray-300 rounded p-2 bg-gray-100">
                                                    @error('puzzle_image')
                                                        <span class="text-red-500 text-sm" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <div class="flex my-2 items-center justify-center">
                                            <div class="basis-6/12 pe-3">
                                                <div class="pe-3 mb-3">
                                                    ...
                                                    <input type="file" data-default-file="{{asset($location->map_image??'backend/assets/images/map-placeholder.jpg')}}" name="map_image" id="image" class="dropify form-input w-full border border-gray-300 rounded p-2 bg-gray-100">
                                                    @error('map_image')
                                                        <span class="text-red-500 text-sm" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="basis-6/12 pe-3">
                                                <div class="pe-3 mb-3">
                                                    ...
                                                    <input type="text" name="map_url" id="map_url" placeholder="https://example.com" value="{{ old('map_url', $location->map_url) }}" class="form-input w-full border border-gray-300 rounded p-2 bg-gray-100">
                                                    @error('map_url')
                                                        <span class="text-red-500 text-sm" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <div class="my-2">
                                            ...
                                            <div class="basis-6/12 pe-3 mb-3">
                                                ...
                                                <textarea name="information" id="information" cols="30" rows="10" placeholder="Enter Information"
                                                    class="form-input w-full border border-gray-300 rounded p-2 bg-gray-100">{!! $location->information !!}</textarea>
                                                @error('information')
                                                    <span class="text-red-500 text-sm" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
