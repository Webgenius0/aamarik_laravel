                        ...
                        <div class="space-y-4">
                            <form class="max-w-6xl w-full mx-auto space-y-4"
                                ...
                                <div class="flex justify-end">
                                    <a href="{{ route('employees.index') }}" class="btn bg-info text-white py-2 px-5 hover:bg-success rounded-md align-right">
                                        Back
                                    </a>
                                </div>
                                <div class="flex-col md:flex-row">
                                    <h1 class="text-center text-lg ">Create Pharmacist</h1>

                                    <label for="applicationTitle"
                                           class=" text-lg font-medium mb-2 md:mb-0 md:w-1/3"> Name
                                    </label>
                                    <div class="w-full">
                                ...
                                <div class="flex flex-col md:flex-row items-center md:space-x-4">
                                    ...
                                    <div class="flex flex-col md:w-1/2">
                                        <label for="phone" class="text-lg font-medium mb-2 md:mb-0">Phone</label>
                                        <input name="phone" type="text" class="form-input w-full" id="phone"  value="">
                                        @error('phone')
                                        <span class="text-red-500 block mt-1 text-sm">
                                        <strong>{{ $message }}</strong>
                                    </span>
