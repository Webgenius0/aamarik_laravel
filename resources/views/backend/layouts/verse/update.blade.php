...
@section('title', 'Edit Verse | ' . $setting->title ?? 'SIS')
                        ...
                        <div class="overflow-hidden">
                            ...
                            <div class="mb-4 bg-white rounded-xl shadow-lg">
                                <div class="relative px-4 py-3 border-b flex justify-between align-middle">
                                    <h6 class="text-lg font-semibold mb-0">Edit Verse</h6>
                                    ...
                                    <form action="{{ route('verse.update', $verse->id) }}" method="POST">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="basis-6/12 pe-3 mb-3">
                                                ...
                                                <textarea name="content" id="content" cols="30" rows="10" placeholder="Enter Content" class="form-input w-full border border-gray-300 rounded p-2 bg-gray-100">{{ old('content', $verse->content) }}</textarea>
                                                @error('content')
                                        ...
                                        <div class="mt-5 ">
                                            ...
                                            <div class=" pe-3 mb-3">
                                                ...
                                                <input type="text" name="reference" id="reference" placeholder="Enter Reference" value="{{ old('reference', $verse->reference) }}"
