...
//        'pdf' => [
//            'backend' => 'GD', // Change from 'Imagick' to 'GD'
//        ],
//
//    ],
//
...
return [
    ...
    /*
     * Convert entities like €, £ correctly
     */
    'convert_entities' => true,

    'options' => [
        /*
         * Set Font Directory to be writable
         */
        'font_dir' => storage_path('fonts'),

        /*
         * Cache Directory for Font Metrics
         */
        'font_cache' => storage_path('fonts'),
        ...
        /*
         * Set Chroot to Base Path
         */
        'chroot' => realpath(base_path()),

        /*
         * Allow Remote URLs (needed for loading external images or fonts)
         */
        'enable_remote' => true, // Set to true if fetching images from URLs

        /*
         * Allowed Remote Hosts
         */
        'allowed_remote_hosts' => null, // Set a list of domains if needed

        /*
         * Force Font Subsetting
         */
        'enable_font_subsetting' => false,

        /*
         * Force Backend to GD (Avoid Imagick Issues)
         */
        'pdf_backend' => 'GD',  // Force use of GD instead of Imagick

        /*
         * Default Paper Size (Letter or A4)
         */
        'default_paper_size' => 'A4',
        ...
        /*
         * Enable Embedded PHP (DISABLE for Security)
         */
        'enable_php' => false,

        /*
         * Use HTML5 Parser (Required for Better PDF Rendering)
         */
        'enable_html5_parser' => true,

        /*
         * Adjust Font Height Ratio
         */
        'font_height_ratio' => 1.1,

        /*
         * Use GD as the Rendering Backend
         */
        'pdf' => [
            'backend' => 'GD',
        ],
